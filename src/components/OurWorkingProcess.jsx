...
export default function OurWorkingProcess() {
  ...
  return (
    <section className="mx-5 md:container md:mx-auto py-10 md:py-20">
      <h5 className="text-2xl md:text-4xl text-primary font-extrabold text-center">Our Working Process</h5>
      ...
      <div className="mt-10 md:mt-20 grid md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
        {works.map((work, i) => (
          <div key={i} className="p-8 border border-primary rounded-xl flex flex-col gap-2.5 group hover:bg-primary hover:text-white ease-linear duration-300">
            <h5 className="text-2xl md:text-4xl bg-primary group-hover:bg-white w-12 h-12 rounded-full flex justify-center items-center text-white group-hover:text-primary ease-linear duration-300">{i}</h5>
