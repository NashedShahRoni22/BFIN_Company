    ...
    <section className="banner">
      <div className="mx-5 md:container md:mx-auto py-10 md:py-20 flex flex-col items-center gap-8 md:gap-16">
        <h1 className="text-4xl md:text-6xl text-center">
          Welcome to <span className="font-semibold text-primary">BFINIT</span>{" "}
          - Pioneers in IT Security and Development
        </h1>
      ...
      <div className="flex justify-center mb-10">
        <ReactPlayer url="https://www.youtube.com/watch?v=zF6BNFXymvE" />
      </div>
      <Businessproof />
    </section>
  );
