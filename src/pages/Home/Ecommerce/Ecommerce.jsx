      ...
      <section className="mx-5 flex flex-col justify-between gap-8 py-10 md:container md:mx-auto md:flex-row md:gap-16 md:py-20">
        <div className="w-full md:h-auto md:w-1/2">
          <img
            ...
            loading="lazy"
            className="max-w-auto mx-auto h-[200px] max-h-full w-auto rounded-t-xl object-contain md:mx-0 md:h-full md:w-full md:object-cover"
          />
          <div className="flex justify-center">
            <Link
              to={"hosting-products/7"}
              className="w-full rounded-b-xl bg-[#186bb5] px-5 py-2.5 text-center text-lg font-medium text-white shadow transition-all duration-200 ease-linear hover:bg-[#145d9c]"
            >
