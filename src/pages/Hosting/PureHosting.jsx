...
export default function PureHosting() {
  const {id} = useParams();
  ...
  useEffect(() => {
    setLoader(true);
    fetch(`https://hpanel.bfinit.com/api/product/list/4`)
      .then((res) => res.json())
      .then((data) => {
      ...
      <div className="py-10 md:py-20 grid gap-8 lg:grid-cols-2">
        <div className="flex flex-col gap-5">
          <h5 className="text-xl md:text-2xl">
            Fully Managed Pure Web Hosting including BITSS WAP
          </h5>
          <p className="text-2xl md:text-4xl text-primary font-semibold">
            Get Fully Managed Pure Web Hosting.
          </p>
