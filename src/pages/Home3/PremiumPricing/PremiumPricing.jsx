          ...
          {ecompricingPlan.slice(4, 6).map((plan, index) => {
            ...
            return (
              ...
              >
                {/* Image Section */}
                <div
                  className={`relative w-full overflow-hidden md:w-1/2 ${isReversed ? "md:order-last" : "md:order-first"}`}
                >
                ...
                {/* Content Section */}
                <div
                  className={`w-full p-6 md:w-1/2 md:p-12 ${isReversed ? "md:order-first" : "md:order-last"}`}
                >
                  {/* Header */}
                  <div className="mb-6">
